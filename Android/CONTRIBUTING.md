...
Whether you find a bug, typo or an API call that could be clarified, please [file an issue](https://github.com/realm/rmp-textscanner-android/issues) on our GitHub repository.
...
We love contributions to Realm! If you'd like to contribute code, documentation, or any other improvements, please [file a Pull Request](https://github.com/realm/rmp-textscanner-android/pulls) on our GitHub repository. Make sure to accept our [CLA](#CLA)!
